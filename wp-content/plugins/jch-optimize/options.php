...
function jch_initialize_settings()
{
	...
	add_settings_field( 'jch_options_pro_cache_platform', __( 'Platform Specific <span class="label label-important">New!</span>', 'jch-optimize' ), 'jch_options_pro_cache_platform_string', 'jch-sections', 'jch_page_cache' );
	...
	add_settings_field( 'jch_options_pro_http2_push_cdn', __( 'Preload CDN files <span class="label label-important">New!</span>', 'jch-optimize' ), 'jch_options_pro_http2_push_cdn_string', 'jch-sections', 'jch_pro_http2_push' );
	...
	add_settings_field( 'jch_options_pro_http2_exclude', __( 'Exclude files <span class="label label-important">New!</span>', 'jch-optimize' ), 'jch_options_pro_http2_exclude_string', 'jch-sections', 'jch_pro_http2_push' );
	...
	add_settings_field( 'jch_options_pro_lazyload_bgimages', __( 'Background images <span class="label label-important">New!</span>', 'jch-optimize' ), 'jch_options_pro_lazyload_bgimages_string', 'jch-sections', 'jch_pro_lazyload' );
	add_settings_field( 'jch_options_pro_lazyload_audiovideo', __( 'Audio/Video <span class="label label-important">New!</span>', 'jch-optimize' ), 'jch_options_pro_lazyload_audiovideo_string', 'jch-sections', 'jch_pro_lazyload' );
...
function jch_options_pro_cache_platform_string()
{
...
function jch_options_pro_http2_push_cdn_string()
{
...
function jch_options_pro_http2_exclude_string()
{
...
function jch_options_pro_lazyload_bgimages_string()
{
...
function jch_options_pro_lazyload_audiovideo_string()
{
