...
class Combiner
{
	 ...
	 * @param   HtmlProcessor  $oHtmlProcessor
	 * @param   bool           $bBackend
	 */
	public function __construct( Settings $params, HtmlProcessor $oHtmlProcessor, $bBackend = false )
	{
		$this->params         = $params;
	...
	public function cacheContent( $aUrl, $sType, $bPrepare )
	{
		...
		if ( $sType == 'css' )
		{
			...
			$oCssProcessor->processAtRules( $this->oHtmlProcessor );
